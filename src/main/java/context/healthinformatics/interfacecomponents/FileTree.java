...
public class FileTree implements TreeSelectionListener, Serializable {
	 ...
	 * 
	 * @param titlePanel
	 *            where the title for file selection must come.
	 */
	...
	/**
	 * Method which initializes the tree.
	 */
	...
	/**
	 * Method which creates the tree and fills it with all the nodes currently
	 * in the folder.
	 */
	...
	/**
	 * @param panel
	 *            to which the treePane will be added.
	 */
	private void addTreePane(JPanel panel) {
		...
		c.weightx = 1;
		c.insets = new Insets(InputPageComponents.BUTTONINSETS,
				InputPageComponents.BUTTONINSETS,
				InputPageComponents.BUTTONINSETS,
				InputPageComponents.BUTTONINSETS);
	 ...
	 * 
	 * @param selected
	 *            is the string of the selected TreeNode.
	 * @param node
	 *            is the selected TreeNode.
	 */
	...
	private void setNodeToSelected(String selected, DefaultMutableTreeNode node) {
		DefaultMutableTreeNode project = (DefaultMutableTreeNode) node
				.getParent();
	 ...
	 *            is the selected TreeNode.
	 */
	private void setNodeToNotSelected(String selected,
